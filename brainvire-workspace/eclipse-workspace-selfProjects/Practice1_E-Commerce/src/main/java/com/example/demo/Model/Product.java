...
public class Product {
	...
	public Product(long id, String title, String description, int price, int discountedPrice, int discountPercent,
			...
			List<Review> reviews, int numRatrings, Category category, LocalDateTime createdAt) {
		super();
		this.id = id;
		this.title = title;
	...
	public int getNumRatrings() {
		return numRatrings;
	}

	public void setNumRatrings(int numRatrings) {
		this.numRatrings = numRatrings;
	}
