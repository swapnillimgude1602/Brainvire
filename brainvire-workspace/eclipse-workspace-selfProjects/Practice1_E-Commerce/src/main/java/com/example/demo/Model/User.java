...
public class User {
	...
	@Embedded // not entity so embedded
	@ElementCollection // another table created
	@CollectionTable(name = "payment_information", joinColumns = @JoinColumn(name = "user_id")) // rows,fields name
																								// change
	private List<PaymentInformation> paymentinformations = new ArrayList<>();

	@OneToMany(mappedBy = "user", cascade = CascadeType.ALL)
	@JsonIgnore // can create nested problem so jsonignore
